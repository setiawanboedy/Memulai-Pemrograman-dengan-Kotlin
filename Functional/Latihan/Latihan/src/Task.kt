...
fun main() {
    ...
    println("""
        First char Kotlin is $kotlinFirstChar and $kotlinLastChar for second letter
        First char Dicoding is $dicodingFirstChar and $dicodingLastChar for second letter
    """.trimIndent())
